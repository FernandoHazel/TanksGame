...
/*
All the code related to damage and healt is not used
 */
    ...
    public class ShellController : MonoBehaviour
    {
        ...
        private void OnCollisionEnter (Collision collision)
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                // Find the WallHealth script associated with the rigidbody.
                WallHealth targetHealth = targetRigidbody.GetComponent<WallHealth> ();

                // If there is no WallHealth script attached to the gameobject, go on to the next collider.
                if (!targetHealth)
                    continue;
